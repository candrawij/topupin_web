...
<head>
    ...
    <title>Edit Produk #<?= $row['id_produk'] ?> - Admin Panel</title>
...
<body class="bg-gray-900 text-gray-100 min-h-screen flex items-center justify-center p-6">
    ...
    <div class="w-full max-w-lg bg-gray-800 border border-gray-700 rounded-3xl p-8 shadow-2xl space-y-6">
        <div class="flex justify-between items-center border-b border-gray-700 pb-4">
            <div>
                <h2 class="text-xl font-bold text-white flex items-center"><i class="fa-solid fa-pen-to-square text-indigo-400 mr-2"></i> Perbarui Produk</h2>
                <p class="text-[11px] text-gray-400 mt-1">Mengubah spesifikasi produk ID #<?= $row['id_produk'] ?></p>
            </div>
        ...
        <form action="update_produk.php" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <select name="kategori" required onchange="toggleFields(this.value)"
                    ...
                    <option value="topup" <?= $row['kategori'] == 'topup' ? 'selected' : '' ?>>Top Up (Diamond / UC)</option>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <!-- Nominal (Topup) -->
                <div id="field_nominal" class="<?= $row['kategori'] == 'topup' ? '' : 'hidden' ?>">
                ...
                <!-- Stok (Akun/Item) -->
                <div id="field_stok" class="<?= $row['kategori'] != 'topup' ? '' : 'hidden' ?>">
